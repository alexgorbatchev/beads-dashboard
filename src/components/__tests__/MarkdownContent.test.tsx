...
describe("MarkdownContent", () => {
  ...
  it("preserves authored line breaks", () => {
    ...
    expect(html).toBe(
      '<div class="markdown-content text-sm text-secondary leading-relaxed"><p>first line<br/>\nsecond line</p></div>',
    );
  });
});
